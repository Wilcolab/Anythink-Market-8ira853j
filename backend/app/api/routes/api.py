...
from app.api.routes import authentication, comments, profiles, tags, users, ping, ratings
...
router.include_router(ratings.router, prefix="/items/{slug}/ratings", tags=["ratings"])
