# Smart Meeting Assistant â€“ Spec-Driven Development Spec
...
1. **Automated Transcription & Summarization**
   ...
   - Extract action items (e.g., â€œYou said you wouldâ€¦â€).
...
4. **User Workflow**
   ...
   - â€˜Send to Stakeholdersâ€™ function for distributing results (GitHub, Email, Slack, Calendar).
...
- User consent for recording/transcription can be managed through SparkFleetâ€™s UI.
- Not assuming real-time transcriptionâ€”post-meeting processing preferred in first iteration.
...
- [ ] Key decisions and â€œYou said you wouldâ€¦â€ actions are captured and displayed in SparkFleet.
...
- [ ] Confidence scores and â€œNeed clarificationâ€ tags shown for uncertain extracted items.
